...
related_documents:
  governance:
    ...
    - GOV-013 (Engineering Lifecycle, v0.1.0 Approved; v0.2.0 amendment candidate) — v0.1.0 was Approved via Normal-Governance disposition (evidence commit `3ac7cfb2e953004e891586e5ffef31e5d4fc87a6`, effective 2026-07-26). The v0.2.0 candidate defines the Founder-stage AI-assisted independent technical review model this v0.3.0 candidate applies narrowly to Independent Engineering Review and Independent Implementation Review. Neither candidate is approved merely by being authored or committed. GOV-013 remains the sole governing authority for every lifecycle stage through Engineering Work Order authoring (its own §6.1–§6.12); this standard does not restate, amend, or supersede any of them — it begins only where GOV-013 §6.12 ends (§2).
  standards:
...
> **Status notice.** This v0.3.0 amendment is **Draft** and has not been reviewed or approved. STD-031 v0.2.1 remains the prior Approved version following Founder Approval on 2026-07-29. That prior disposition does not approve this changed artifact. Drafting, saving, staging, committing, or pushing v0.3.0 does not itself constitute review, approval, implementation authorization, acceptance, release authorization, or deployment authorization. See §18 (Approval Status).

> **Revision notice.** v0.3.0 is a MINOR, backward-compatible clarification applying GOV-013 v0.2.0's Founder-Stage AI-Assisted Independent Technical Review (FS-AITR) model only to this standard's Independent Engineering Review (§7.1) and Independent Implementation Review (§7.5). "Independent technical" means adversarial evidence re-derivation and does not make AI review independent human review. This amendment preserves both stages, their existing severities, STOP handling, correction loops, exact-artifact and evidence requirements, and exit criteria, and grants no approval or implementation authority. v0.2.0 and v0.2.1's prior correction history remains preserved in §17.
...
**Required Outputs.** A classified findings list and exactly one recorded technical recommendation or verdict. Where FS-AITR is used, the AI Technical Review Report and the separate Founder Human Review Disposition are both required; neither is Founder Approval (§7.2).
...
**FS-AITR application.** Where no qualified non-author human reviewer is available and the review is R0, R1, or R2, the technical review evidence MAY be produced through GOV-013 §8.7–§8.10. The AI system holds no Reviewer, Approval, or Acceptance Authority. Its report MUST contain this exact disclosure: "This review was performed by an AI system and is not an independent human review." Before this stage may exit on that report, the Founder MUST personally record a separate Founder Human Review Disposition accepting the exact report as sufficient technical review evidence. The disposition does not approve, accept, or authorize the implementation. R3 work and work after the applicable sunset require a qualified non-author human reviewer; AI evidence may then be supporting evidence only.
...
- Where FS-AITR is proposed: a recorded R0–R3 classification against the actual scope and exposure; confirmation that no GOV-013 §8.9 R3 trigger applies; confirmation that no GOV-013 §8.10 sunset condition applies; and disclosure that no qualified non-author human reviewer is available.
...
- Where FS-AITR supplied the applicable technical review evidence: confirmation that the exact AI Technical Review Report carries the mandatory disclosure and that the Founder personally recorded the separate Founder Human Review Disposition required by GOV-013 §8.8. That verification MUST NOT merge the human disposition with Founder Approval, Founder Acceptance, implementation authorization, or release/deployment authorization.
...
This standard follows STD-001 §13's versioning rule: PATCH for editorial correction, MINOR for backward-compatible addition or clarification, MAJOR for a change to obligation, stage ordering, or authority assignment. v0.2.0 was MAJOR because it corrected a scope and stage-ordering defect. This v0.3.0 amendment is MINOR: it adds a backward-compatible, temporary evidence-and-human-disposition method under GOV-013 §8.7–§8.10 without changing a stage, stage order, severity, correction loop, exit criterion, or authority assignment (§17).
...
The v0.3.0 FS-AITR clarification applies prospectively only after this amendment becomes effective. Historical AI review evidence is neither relabeled nor invalidated; it may be prospectively recognized only through the distinct Founder Human Review Disposition and historical-integrity conditions in GOV-013 §8.10. The current EWO-028 and EMO-002 scopes are R2, not R3, under GOV-013 §8.9; that classification is not a review, disposition, approval, or implementation authorization and must be revisited if either scope or exposure changes.
...
- GOV-013 — Engineering Lifecycle (v0.1.0 Approved via Normal-Governance disposition, evidence commit `3ac7cfb2e953004e891586e5ffef31e5d4fc87a6`; v0.2.0 amendment candidate) — the sole authority for every stage through Engineering Work Order authoring, for Implementation, Independent Implementation Review, Engineering Report, and Publication as generic concepts, and for the FS-AITR model this v0.3.0 candidate applies
...
| 0.3.0 | 2026-08-13 | Denver Jacobs (AI-assisted) | MINOR amendment candidate applying GOV-013 v0.2.0's FS-AITR model narrowly to Independent Engineering Review (§7.1) and Independent Implementation Review (§7.5). Adds the mandatory exact AI disclosure, separate personal Founder Human Review Disposition, R0–R3 and sunset prechecks, and prospective historical-recognition rule by direct reference to GOV-013 §8.7–§8.10. Preserves both existing stages, Critical/Major/Minor/Observation severity semantics, correction and narrow re-review loops, evidence requirements, exit criteria, Founder Approval, Founder Acceptance, and all authority boundaries. Does not claim review or approval of this candidate and grants no implementation, release, deployment, risk-acceptance, or external authority. |
...
| Amendment Author | Denver Jacobs (AI-assisted) | v0.3.0 candidate authored; no review or approval claimed | 2026-08-13 |
| Independent Engineering Review — v0.3.0 | TBD | Pending | |
| Founder Human Review Disposition — v0.3.0 | TBD, if FS-AITR is used | Not performed | |
| Approval Authority — v0.3.0 | Founder (Denver Jacobs), under the authority basis stated in frontmatter | Pending; v0.3.0 is not approved | |

STD-031 v0.2.1 remains the prior **Approved** version. This v0.3.0 artifact is a new Draft amendment candidate and is not approved by the v0.2.1 disposition. Its authoring and publication commit is not an Independent Engineering Review, Founder Human Review Disposition, Founder Approval, implementation authorization, Founder Acceptance, release authorization, or deployment authorization. Those remain distinct acts and must be separately performed and evidenced if the candidate proceeds.
