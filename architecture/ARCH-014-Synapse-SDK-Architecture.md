...
| Title | Synapse SDK Architecture |
| Version | 0.7.0 |
| Status | **Approved** (Founder Architecture Approval for the v0.6.0 amendment recorded, §25; v0.4.0's own Founder Architecture Approval remains a separate, accurate historical record of what was approved at that time) |
